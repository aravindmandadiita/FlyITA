<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Session.aspx.cs" Inherits="FlyITA.Diagnostics.Session" %>
<!DOCTYPE html>
...
<body>
    ...
    <hr />
    <div id="paxdump">
        <asp:Literal ID="litSession" runat="server" Mode="PassThrough" EnableViewState="false" />
    </div>
    </form>
</body>
</html>
